...
namespace Taro.Repository.Identity.Migrations
{
    ...
    [Migration("20231120134851_AddQuizTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Taro.Core.Entities.Models.CourseModels.Quiz", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Taro.Core.Entities.Roles.Role", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Address", b =>
                {
                    b.HasOne("AppUser", "User")
                        .WithOne("address")
                        .HasForeignKey("Address", "AppUserId")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("Taro.Core.Entities.Roles.Role", null)
                        .WithMany()
